  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto max-w-3xl px-5 py-10 sm:px-8 sm:py-16">
        <nav aria-label="Rechtliches" className="mb-10 border-b border-slate-200 pb-4">
        ...
        <footer className="mt-12 border-t border-slate-200 pt-4 text-sm text-slate-500">
          <p>
            Diese Texte sind eine Vorlage und ersetzen keine Rechtsberatung. Vor dem
            produktiven Einsatz durch eine qualifizierte Stelle prüfen lassen.
          </p>
        </footer>
      </div>
    </div>
