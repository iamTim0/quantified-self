...
import { MapPin, Navigation, Calendar, ShieldCheck } from "lucide-react";
...
export default function LocationMap({ apiBase, token, tenantId }: LocationMapProps) {
  ...
  useEffect(() => {
    ...
    // CartoDB Voyager / OpenStreetMap Tile Layer
    L.tileLayer("https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png", {
      attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> &copy; <a href="https://carto.com/">CARTO</a>',
      maxZoom: 19,
    }).addTo(map);

    // Custom Emerald Map Marker Icon
  ...
  if (points.length === 0) {
    return null; // Hide if no location points logged yet
  }
  ...
  return (
    <div className="glass-card p-6 bg-white border border-slate-200/80 rounded-3xl space-y-4 shadow-sm">
      ...
      {/* Map Container */}
      <div className="relative w-full h-[380px] rounded-2xl overflow-hidden border border-slate-200 z-0">
