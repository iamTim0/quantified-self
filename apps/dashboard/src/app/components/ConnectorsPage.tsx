...
import { Plus, RefreshCw, Settings, ShieldCheck, Key, AlertTriangle, CheckCircle2, Flame, MapPin, ArrowUpRight } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {AVAILABLE_CATALOG.map((cat) => {
          ...
          return (
            <div
              key={cat.id}
              className="glass-card p-6 bg-white border border-slate-200/80 rounded-3xl flex flex-col justify-between space-y-4"
            >
                ...
                {isConfigured ? (
                  <>
                    ...
                    >
                      ...
                      <span>{syncingSource === cat.id ? "Import läuft..." : "Jetzt Synchronisieren"}</span>
                    </button>
                    <button
